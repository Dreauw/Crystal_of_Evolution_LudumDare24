package entities.towers {
	...
	public class PoisonTower2 extends TowerBase {
		public static var price:uint = 100;
		public function PoisonTower2(x:Number, y:Number) {
			super(x, y);
			graphic = new Image(Resource.POISON_TOWER_2);
			mask = getMask();
		...
		static public function getDescription():String {
			return "Poison ennemy\nPrice : "+PoisonTower2.price.toString()+"PO";
		}
	}
}