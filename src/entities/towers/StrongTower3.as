package entities.towers {
	...
	public class StrongTower3 extends TowerBase {
		public static var price:uint = 100;
		public function StrongTower3(x:Number, y:Number) {
			super(x, y);
			graphic = new Image(Resource.STRONG_TOWER_3);
			mask = getMask();
